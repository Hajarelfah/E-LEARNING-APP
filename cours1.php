...
?>
    <header>
        <h1 class="html">Cours HTML :</h1><br>
    </header>
<p class="para3">Apprendre HTML de zéro</p>
    <main>
        <div class="video-container">
         
            <iframe width="360" height="215" src="https://www.youtube.com/embed/qsbkZ7gIKnc?si=k_xXDycbpjmVEg7S"
